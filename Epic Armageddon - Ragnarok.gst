...
<gameSystem id="sys-ddf1-f1c4-f4c4-87c4" name="Epic Armageddon - Ragnarok" battleScribeVersion="2.03" revision="1" type="gameSystem" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <categoryEntries>
    ...
    <categoryEntry name="Spacecraft" id="3680-8ae3-3e82-721f" hidden="false">
      <constraints>
        <constraint type="max" value="1" field="selections" scope="roster" shared="true" id="7ccf-3ee9-d845-df69" includeChildSelections="true"/>
      </constraints>
    </categoryEntry>
  </categoryEntries>
  <costTypes>
  ...
  <profileTypes>
    ...
    <profileType name="Ranged Weapon" id="9cd9-726a-f371-515f" hidden="false" sortIndex="6">
      <characteristicTypes>
    ...
    <profileType name="Small Arms" id="1bab-1f5d-14e6-a4e3" hidden="false" sortIndex="12">
      <characteristicTypes>
        <characteristicType name="Abilities" id="1829-9fe2-e1e4-16b3"/>
      </characteristicTypes>
    </profileType>
    <profileType name="Assault Weapons" id="44a3-a559-e997-e821" hidden="false" sortIndex="13">
      <characteristicTypes>
        <characteristicType name="Abilities" id="6f05-5c06-8205-86d1"/>
      </characteristicTypes>
    </profileType>
    <profileType name="Barrage" id="7ad8-0be0-74ea-cc38" hidden="false" sortIndex="9">
      <characteristicTypes>
    ...
    <profileType name="Transport" id="0a48-73e7-5d18-a84d" hidden="false" sortIndex="14">
      <characteristicTypes>
        <characteristicType name="Capacity" id="61b0-a4ea-9433-14e9"/>
        <characteristicType name="Can Transport:" id="c160-32b7-e87e-6bac"/>
      </characteristicTypes>
    </profileType>
    <profileType name="Orbital Bombardment" id="1aab-b9e8-f3ed-fd0e" hidden="false" sortIndex="11">
      <characteristicTypes>
        <characteristicType name="BP" id="dd4f-f3c1-884e-81c5"/>
        <characteristicType name="Abilities" id="b4ec-b5cf-58b4-3811"/>
      </characteristicTypes>
    </profileType>
    <profileType name="Pinpoint" id="0803-c0d2-6f78-96e4" hidden="false" sortIndex="7">
      <characteristicTypes>
        <characteristicType name="Firepower" id="11fd-e1aa-bd8a-48a8"/>
        <characteristicType name="Abilities" id="d12a-0d9e-e457-e370"/>
      </characteristicTypes>
    </profileType>
    <profileType name="Spacecraft" id="c3f6-352a-f169-3ad1" hidden="false" sortIndex="4">
      <characteristicTypes>
        <characteristicType name="Arrive on Turn" id="8e81-527a-c849-2da6"/>
        <characteristicType name="Abilities" id="53d7-016d-725e-d42f"/>
      </characteristicTypes>
    </profileType>
  </profileTypes>
  <sharedProfiles>
